...
final class SettingsStore: ObservableObject {
    ...
    // 그리드
    @Published var columns: Int { didSet { guard !loading else { return }; Settings.shared.columns = columns; notify() } }
    @Published var rows: Int { didSet { guard !loading else { return }; Settings.shared.rows = rows; notify() } }
    @Published var outerMargin: Double { didSet { guard !loading else { return }; Settings.shared.outerMargin = outerMargin; notify() } }
    @Published var innerGap: Double { didSet { guard !loading else { return }; Settings.shared.innerGap = innerGap; notify() } }
    ...
    // 예외 앱
    @Published var excludedApps: [String] { didSet { guard !loading else { return }; Settings.shared.excludedApps = excludedApps } }
